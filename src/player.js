...
(function() {
  ...
  WhelkShell = (function(_super) {
    ...
    WhelkShell.prototype.itemSort = 'whelk';

    WhelkShell.prototype.legendDesc = 'Whelk Shell';

    WhelkShell.prototype.statusDesc = function() {
      return 'whelk shell';
    };

    WhelkShell.prototype.character = 'W';
  ...
  DownStairs = (function(_super) {
    ...
    DownStairs.prototype.character = '>';
  ...
  Player = (function(_super) {
    ...
    Player.prototype.tryMoveTo = function(x, y, opts) {
      var entities, entity, moveInfo, skipBumpMsg, _j, _len1;
      ...
      if (!moveInfo.canMove) {
        ...
        if (!skipBumpMsg && (moveInfo.bump != null)) {
          this.level.addStatus(moveInfo.bump);
        }
        return;
      } else if ((entities = this.level.entitiesAtCell(x, y)).length) {
        for (_j = 0, _len1 = entities.length; _j < _len1; _j++) {
          entity = entities[_j];
          if (entity.hostile) {
            this.melee(entity, opts);
            return;
          } else if ((typeof entity.preBump === "function" ? entity.preBump(this, opts) : void 0) === BUMP_CANCEL_MOVE) {
            return;
          }
        }
      }
  ...
  NPC = (function(_super) {
    ...
    NPC.prototype.legendDesc = 'Man on Stool';

    NPC.prototype.preBump = function(e) {
      if (e.group === 'players') {
