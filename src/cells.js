...
(function() {
  var cell, cellName, cells, colorArrayFromStrings, getBumpMessage, mirrorBumpFunc;

  mirrorBumpFunc = function(entity) {
    var dmgAmount;
    dmgAmount = 5;
    entity.damage({
      sentence: 'You glance at yourself in the mirror. %s'.format(statusColor(constants.selfEsteemColor, '(%s self-esteem)'.format(statusColor('red', '' + (-dmgAmount))))),
      amount: 5
    });
    return false;
  };
